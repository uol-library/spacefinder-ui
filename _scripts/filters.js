 ...
 */
export { setupFilters, getFilterStatus };
/**
 * gets the current status of all filters
 * @return {Array} activeFilters array of name/value pair objects
 */
...
/**
 * sets up the filters panel of the UI
 */
function setupFilters() {
    /* event triggered when filters are changed */
