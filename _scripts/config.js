export const spacesurl = 'https://uol-library.github.io/spacefinder-ui/spaces.json';
export const imageBaseURL = 'https://uol-library.github.io/spacefinder-ui/assets/photos/';
export const spaces = [];
export const currentLoc = {'lat': 52.205575, 'lng': 0.121682};
